...
<div id="lcc-chat-container" class="fixed bottom-5 right-5 z-[99999]">
    <div id="lcc-chat-toggle" class="w-16 h-16 rounded-full flex items-center justify-center cursor-pointer shadow-lg transform hover:scale-110 transition-transform">
        <?php if ($bubble_logo_url): ?>
            <img src="<?php echo esc_url($bubble_logo_url); ?>" alt="Chat" class="w-10 h-10 rounded-full object-cover">
        <?php else: ?>
